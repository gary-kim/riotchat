OC.L10N.register(
    ...
    "Make share room links go to Element for Nextcloud instead of https://matrix.to" : "A megosztási szoba linkjeit a https://matrix.to helyett állítsa az Element for Nextcloudra",
    "Set custom permalink to this Element instance" : "Egyéni állandó kapcsolat beállítása ehhez az Element példányhoz",
    ...
    "Custom Jitsi instance (leave blank to use default Element Jitsi server):" : "Egyéni Jitsi példány (az Elements alapértelmezett Jitsi kiszolgálója esetén hagyja üresen):",
    ...
    "This version of Element for Nextcloud is based on Element Web {riotWebVersion}. Check out the source code for Element Web {linkstart}here{linkend}." : "A Riot csevegő nextcloudos verziója a Element Web {riotWebVersion} alapjaira épül. Nézze meg az Element Web forráskódját {linkstart}itt{linkend}.",
