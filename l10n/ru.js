OC.L10N.register(
    ...
    "Set custom permalink to this Element instance" : "Установить пользовательскую постоянную ссылку для этого сервера Element",
    ...
    "Custom integration server" : "Пользовательский сервер интеграции",
    "Configure a custom integration server for Element (leave empty to use Scalar)." : "Настройте собственный сервер интеграции для Element (оставьте поле пустым, чтобы использовать Scalar).",
    "Integration UI URL:" : "URL-адрес интерфейса интеграции:",
    "Integration REST URL:" : "URL-адрес REST интеграции:",
