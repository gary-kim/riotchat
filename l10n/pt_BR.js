OC.L10N.register(
    ...
    "Disable redirect to non-iframed version for SSO (make sure to set the headers to allow the SSO or CAS to be iframed)" : "Desativar o redirecionamento para a versão sem iframe para SSO (certifique-se de definir os cabeçalhos para permitir que o SSO ou CAS seja exibido em iframe)",
    ...
    "Set custom permalink to this Element instance" : "Definir permalink personalizado para esta instância do Element",
