OC.L10N.register(
    ...
    "Default server name:" : "Ainm an fhreastalaí réamhshocraithe:",
    ...
    "Set custom permalink to this Element instance" : "Socraigh permalink saincheaptha don ásc Eilimint seo",
    "Jitsi settings" : "Socruithe Jitsi",
    "Configure the Jitsi instance that Element will connect to." : "Cumraigh an sampla Jitsi a nascfaidh Element leis.",
    "Custom Jitsi instance (leave blank to use default Element Jitsi server):" : "Sampla saincheaptha Jitsi (fág bán chun an freastalaí réamhshocraithe Element Jitsi a úsáid):",
    "Custom integration server" : "Freastalaí comhtháthú saincheaptha",
    "Configure a custom integration server for Element (leave empty to use Scalar)." : "Cumraigh freastalaí comhtháthú saincheaptha le haghaidh Element (fág folamh chun Scalar a úsáid).",
    "Integration UI URL:" : "URL Chomhéadain Chomhtháthaithe:",
    "Integration REST URL:" : "Comhtháthú REST URL:",
