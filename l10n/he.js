OC.L10N.register(
    ...
    "Configure Element here" : "ניתן להגדיר את Element מכאן",
    ...
    "Configure the Jitsi instance that Element will connect to" : "יש להגדיר את עותק ה־Jitsi אליו יתחבר Element",
    ...
    "Configure a custom integration server for Element (leave empty to use Scalar)" : "הגדרת שרת שילוב מותאם אישית עבור Element (יש להשאיר ריק כדי להשתמש ב־Scalar)",
    ...
    "Specify a custom configuration for Element" : "נא לציין הגדרות מותאמות אישית עבור Element",
