...
import React, {createContext, MouseEvent, ReactElement, ReactNode, useContext, useRef, useState, useEffect} from "react";
...
function nextcloudPickerButton(): ReactElement | null {
    const isPickerEnabled = (() => {
        if (window.parent && window.parent._oc_appswebroots) {
            // @ts-ignore
