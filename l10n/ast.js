OC.L10N.register(
    ...
    "Default server name:" : "Nome del sirvidor predetermináu:",
    "Disable custom URLs" : "Desactivar les URLs personalizaes",
    "Jitsi settings" : "Configuración de Jitsi",
    "Configure the Jitsi instance that Element will connect to." : "Configura la instancia de Jitsi a la que va conectase Element.",
    "Custom integration server" : "Sirvidor d'integración personalizáu",
    "Custom Element config" : "Personalizar la configuración d'element",
    "Specify a custom configuration for Element." : "Especifica una configuración personalizada pa Element.",
