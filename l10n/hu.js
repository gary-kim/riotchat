OC.L10N.register(
    ...
    "This version of Element for Nextcloud is based on Element Web {riotWebVersion}. Check out the source code for Element Web {linkstart}here{linkend}." : "Az Element nextcloudos verziója az Element Web {riotWebVersion} alapjaira épül. Nézze meg az Element Web forráskódját {linkstart}itt{linkend}.",
    ...
    "Redirect immediately to SSO (requires SSO to be configured on the Matrix Homeserver)" : "Azonnali átirányítás az SSO-hoz (szükséges az SSO beállítása a Matrix-kiszolgálón)",
    "Disable redirect to non-iframed version for SSO (make sure to set the headers to allow the SSO or CAS to be iframed)" : "Az SSO nem iframe-alapú verziójára történő átirányítás letiltása (győződjön meg róla, hogy engedélyezte-e, hogy az SSO vagy a CAS iframe-be tehető legyen)",
    "External domains allowed to be iframed:" : "Iframe-ben engedélyezett külső tartományok:",
    ...
    "Make share room links go to Element for Nextcloud instead of https://matrix.to" : "A szoba megosztási hivatkozások a https://matrix.to helyett az Element a Nextcloudhoz alkalmazáshoz mutassanak",
    "Set custom permalink to this Element instance" : "Egyéni állandó hivatkozás beállítása ehhez az Element példányhoz",
    "Jitsi settings" : "Jitsi beállítások",
    "Configure the Jitsi instance that Element will connect to." : "A Jitsi példány beállítása, amelyhez az Element csatlakozni fog.",
    "Custom Jitsi instance (leave blank to use default Element Jitsi server):" : "Egyéni Jitsi példány (az Element alapértelmezett Jitsi kiszolgálója esetén hagyja üresen):",
    "Custom integration server" : "Egyéni integrációs kiszolgáló",
    "Configure a custom integration server for Element (leave empty to use Scalar)." : "Egyéni integrációs kiszolgáló beállítása az Element számára (a Scalar használatához hagyja üresen).",
    "Integration UI URL:" : "Integrációs felhasználói felület URL-je:",
    "Integration REST URL:" : "Integráció REST URL-je:",
