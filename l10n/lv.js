OC.L10N.register(
    ...
    "{settingName} could not be set. Try reloading the page." : "{settingName} nevarēja iestatīt. Jāmēģina pārlādēt lapu.",
    "Default server name:" : "Noklusējuma servera nosaukums:",
